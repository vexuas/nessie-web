...
export default function PrivacyPolicy() {
  return (
    <div className={styles.Section} data-testid="PrivacyPolicy" id="privacy_policy">
      ...
      <div className={styles.Description}>
        ...
        <ul>
          ...
          <li>
            Interactions you have made with the Bot, including commands executed, time of execution,
            Discord server, channel and user of execution, and any arguments passed to the command.
          </li>
        </ul>
        <p>
